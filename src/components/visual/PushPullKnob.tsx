  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <div className="relative h-16 w-16">
        ...
        <div 
          ...
          onClick={(e) => {
            ...
            if (isManaged) onPull(); else onPush();
          }}
          onContextMenu={(e) => {
            e.preventDefault();
            onPush();
      ...
      <div className="flex gap-2">
        <button onClick={onPush} className="text-[8px] text-white/40 hover:text-white">PUSH</button>
        <button onClick={onPull} className="text-[8px] text-white/40 hover:text-white">PULL</button>
      </div>
    </div>
  );
}
