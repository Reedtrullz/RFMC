    ...
    <g data-testid="b737-nd-renderer">
      ...
      {model.irsState !== 'NAV' && (
        <g transform="translate(50 50)">
          ...
          <text y="-3" fill={model.irsState === 'ALIGNING' ? '#00ff00' : '#ffcc00'} fontSize="6" fontWeight="bold" textAnchor="middle" letterSpacing="1.5" stroke="black" strokeWidth="0.4" paintOrder="stroke" strokeLinejoin="round">
            {model.irsState === 'OFF' ? 'MAP FAILURE' : 'IRS ALIGN'}
          </text>
          {model.irsState === 'ALIGNING' && (
            <text y="5" fill="#ffcc00" fontSize="3" textAnchor="middle" opacity="0.8" stroke="black" strokeWidth="0.4" paintOrder="stroke" strokeLinejoin="round">ALIGNING...</text>
          )}
        </g>
      )}
      ...
      <g transform="translate(96 94)" textAnchor="end" fontSize="3" fill="#ffffff" opacity="0.8">
        <text y="-4" stroke="black" strokeWidth="0.4" paintOrder="stroke" strokeLinejoin="round">RNP {model.rnpNm.toFixed(2)}</text>
        <text fill={model.anpNm > model.rnpNm ? '#ffcc00' : '#ffffff'} stroke="black" strokeWidth="0.4" paintOrder="stroke" strokeLinejoin="round">ANP {model.anpNm.toFixed(2)}</text>
      </g>
      
      <g transform="translate(4 94)" fontSize="3.2" fill={colors.active} fontWeight="bold">
        <text stroke="black" strokeWidth="0.4" paintOrder="stroke" strokeLinejoin="round">FMC L</text>
      </g>
      ...
      <g transform="translate(4 64)" fontSize="2.8" fontWeight="bold" fill="#00ccff" opacity="0.95" className="font-mono">
        <text fill={model.overlays.arpt ? '#00ccff' : '#3a4d5c'} stroke="black" strokeWidth="0.4" paintOrder="stroke" strokeLinejoin="round">ARPT</text>
        <text y="3.4" fill={model.overlays.wpt ? '#00ccff' : '#3a4d5c'} stroke="black" strokeWidth="0.4" paintOrder="stroke" strokeLinejoin="round">WPT</text>
        <text y="6.8" fill={model.overlays.sta ? '#00ccff' : '#3a4d5c'} stroke="black" strokeWidth="0.4" paintOrder="stroke" strokeLinejoin="round">STA</text>
        <text y="10.2" fill={model.overlays.terr ? '#00ccff' : '#3a4d5c'} stroke="black" strokeWidth="0.4" paintOrder="stroke" strokeLinejoin="round">TERR</text>
        <text y="13.6" fill={model.overlays.tfc ? '#00ccff' : '#3a4d5c'} stroke="black" strokeWidth="0.4" paintOrder="stroke" strokeLinejoin="round">TFC</text>
      </g>

      {/* VOR 1 / ADF 2 Blocks */}
      <g transform="translate(4 82)" fontSize="2.8" fontWeight="bold" fill="#00ff66" opacity="0.95" className="font-mono">
        <text stroke="black" strokeWidth="0.4" paintOrder="stroke" strokeLinejoin="round">VOR 1</text>
        <text y="4.2" fill="#00ff66" stroke="black" strokeWidth="0.4" paintOrder="stroke" strokeLinejoin="round">{model.radios?.vor1 || '111.50'}</text>
        <text y="8.4" fill="#00ff66" stroke="black" strokeWidth="0.4" paintOrder="stroke" strokeLinejoin="round">DME ----</text>
      </g>

      <g transform="translate(96 82)" textAnchor="end" fontSize="2.8" fontWeight="bold" fill="#00ccff" opacity="0.95" className="font-mono">
        <text stroke="black" strokeWidth="0.4" paintOrder="stroke" strokeLinejoin="round">ADF 2</text>
      ...
      {/* MOD Annunciation */}
      {model.isModified && (
        <text x="50" y="92" textAnchor="middle" fill="white" fontSize="4" fontWeight="bold" stroke="black" strokeWidth="0.4" paintOrder="stroke" strokeLinejoin="round">MOD</text>
      )}
    </g>
  );
}
