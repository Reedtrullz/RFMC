    ...
    return (
      <div className="flex h-full w-full items-center justify-center bg-[#111] font-mono">
        <div className="w-[420px] h-[360px] bg-black border border-neutral-900 rounded p-6 flex flex-col justify-between shadow-[inset_0_0_18px_rgba(0,0,0,0.85)]">
          <div className="text-center text-base tracking-widest text-[#00ffff] border-b border-neutral-900 pb-2">CDU NAV DATA UPDATE</div>
          ...
          <div className="text-center text-[10px] text-neutral-600 tracking-tighter uppercase font-bold">AIRAC CYCLE 2405 — PWA-WORKSPACE</div>
        </div>
      </div>
    );
  }
