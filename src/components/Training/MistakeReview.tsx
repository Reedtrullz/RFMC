  ...
  return (
    <div className="mt-6 space-y-3">
      ...
      {mistakes.map((mistake, i) => (
        <div 
          key={mistake.id} 
          className="flex gap-3 p-3 bg-cdu-error/5 border border-cdu-error/20 rounded-lg"
        >
          <div className={`
          ...
          <div className="space-y-1">
            <p className="text-cdu-text text-sm font-cdu">
              {mistake.description}
            </p>
            <p className="text-cdu-text/40 text-[9px] font-cdu uppercase">
              Type: {mistake.type.replace('_', ' ')}
            </p>
          </div>
        </div>
      ))}
