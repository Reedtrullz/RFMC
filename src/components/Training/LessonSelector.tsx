        ...
        <div className="flex bg-cdu-bezel-light/20 p-1 rounded-lg">
          <button
            ...
            className={`px-4 py-1.5 rounded-md text-[10px] font-cdu uppercase transition-all ${
              selectedAircraft === 'BOEING_737' ? 'bg-cdu-cyan text-cdu-bezel font-bold shadow-lg' : 'text-cdu-text/60 hover:text-cdu-text'
            }`}
          >
            Boeing 737
          </button>
          <button
            ...
            className={`px-4 py-1.5 rounded-md text-[10px] font-cdu uppercase transition-all ${
              selectedAircraft === 'AIRBUS_A320' ? 'bg-cdu-cyan text-cdu-bezel font-bold shadow-lg' : 'text-cdu-text/60 hover:text-cdu-text'
            }`}
          >
            Airbus A320
          </button>
              ...
              {lessons.filter(l => l.level === level).map(lesson => (
                ...
                >
                  <div className="flex justify-between items-start mb-2">
                    <span className="text-[10px] font-cdu text-cdu-cyan font-bold uppercase">
                      {lesson.category}
                    </span>
                  ...
                  <p className="text-cdu-text/50 text-[11px] font-cdu leading-snug">
                    {lesson.description}
                  </p>
                  ...
                  <div className="mt-3 flex items-center gap-2">
                    <div className={`
                      ...
                      ${lesson.difficulty === 'basic' ? 'bg-cdu-exec/10 text-cdu-exec' : 
                        lesson.difficulty === 'intermediate' ? 'bg-cdu-cyan/10 text-cdu-cyan' : 
