...
export function CockpitEmptyState({ mode, missingPanels, onRestore }: CockpitEmptyStateProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full p-8 text-center bg-[#0a0c0c]/80 backdrop-blur-md rounded-lg border border-white/5 shadow-2xl" role="status">
      ...
      <p className="text-white/40 text-[11px] font-cdu uppercase tracking-widest mb-8 max-w-sm">
        ...
        <span className="block mt-2 text-amber-500/80 font-black">
          {missing.join(' • ')}
        </span>
      </p>
