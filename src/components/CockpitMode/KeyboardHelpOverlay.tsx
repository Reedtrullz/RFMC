...
export const KeyboardHelpOverlay: React.FC = () => {
  ...
  const shortcuts = [
    ...
    { key: 'Shift + F1–F6', action: 'Right LSK 1–6' },
    ...
    >
      ...
      >
        <div className="flex items-center justify-between border-b border-white/5 bg-black/20 px-6 py-4">
          <h3 id="keyboard-help-title" className="font-cdu text-sm font-bold uppercase tracking-widest text-cdu-cyan">Keyboard Shortcuts</h3>
          <button 
            onClick={toggle}
