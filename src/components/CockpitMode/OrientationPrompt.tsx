...
export function OrientationPrompt() {
  ...
  return (
    <div className="fixed inset-0 z-[10000] bg-black/90 backdrop-blur-md flex flex-col items-center justify-center p-8 text-center animate-in fade-in duration-500">
      ...
      <h2 className="text-2xl font-cdu text-cdu-text uppercase mb-2">Landscape Recommended</h2>
