...
Evidence scope: local checkout on `main` at `810fc9652da431eaf8978b85bf4af131605559b5` (`feat(navdata): add ENVA Trondheim Vaernes airport`), Node `v22.22.3`, npm `10.9.8`. This page records command results from the current local working tree only. It does not claim CI, deployment, physical iPad, Windows/MSFS/PMDG, pilot review, or hardware-reference validation unless that evidence is listed explicitly.
