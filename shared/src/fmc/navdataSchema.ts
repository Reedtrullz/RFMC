...
export function validateRouteFixture(fixture: SimBriefRouteFixture): string[] {
  ...
  if (fixture.aircraft !== 'BOEING_737' && fixture.aircraft !== 'AIRBUS_A320') errors.push('aircraft must be supported');
  ...
  if (!Number.isFinite(fixture.cruiseAltitude) || fixture.cruiseAltitude <= 0) errors.push('cruiseAltitude must be positive');
  ...
  if (!fixture.expected || !Array.isArray(fixture.expected.warnings)) errors.push('expected warnings array is required');
  return errors;
}
