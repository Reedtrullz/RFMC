...
export function buildInitialFMCState(): FMCState {
  return {
    ...
    autopilot: {
      ...
      selectedVS: 0,
      isMachMode: false,
      approachCapability: 'NOT_ARMED',
      flightDirectorA: false,
      flightDirectorB: false,
      spdIntv: false,
      altIntv: false,
      vnavArmed: false,
      lnavArmed: false,
      speedIntervention: false,
      altitudeIntervention: false,
    },

    efisL: {
      mode: 'MAP',
      range: 40,
      overlays: { wpt: false, arpt: false, sta: false, data: false, pos: false, terr: false, wxr: false, tfc: false, cstr: false },
      centered: false,
      side: 'L',
    },
    efisR: {
