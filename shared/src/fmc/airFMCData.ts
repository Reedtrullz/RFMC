...
export const AIRPORTS: Record<string, { name: string; lat: number; lon: number; runways: string[] }> = {
  ...
  KDFW: { name: 'Dallas-Fort Worth Intl', lat: 32.8998, lon: -97.0403, runways: ['13L', '13R', '17L', '17C', '17R', '18L', '18R', '31L', '31R', '35L', '35C', '35R', '36L', '36R'] },
  KDEN: { name: 'Denver Intl', lat: 39.8561, lon: -104.6737, runways: ['07', '08', '16L', '16R', '17L', '17R', '25', '26', '34L', '34R', '35L', '35R'] },
  ...
  KMCO: { name: 'Orlando Intl', lat: 28.4294, lon: -81.3089, runways: ['17L', '17R', '18L', '18R', '35L', '35R', '36L', '36R'] },
  KMIA: { name: 'Miami Intl', lat: 25.7959, lon: -80.2870, runways: ['08L', '08R', '09', '12', '26L', '26R', '27', '30'] },
  KCLT: { name: 'Charlotte Douglas Intl', lat: 35.2140, lon: -80.9431, runways: ['18C', '18L', '18R', '36C', '36L', '36R'] },
  ...
  KPHX: { name: 'Phoenix Sky Harbor Intl', lat: 33.4343, lon: -112.0116, runways: ['07L', '07R', '08', '25L', '25R', '26'] },
  KIAH: { name: 'George Bush Intercontinental', lat: 29.9902, lon: -95.3368, runways: ['08L', '08R', '09', '15L', '15R', '26L', '26R', '27', '33L', '33R'] },
  KBOS: { name: 'Boston Logan Intl', lat: 42.3656, lon: -71.0096, runways: ['04L', '04R', '09', '14', '15L', '15R', '22L', '22R', '27', '33L', '33R'] },
  KFLL: { name: 'Fort Lauderdale-Hollywood Intl', lat: 26.0726, lon: -80.1524, runways: ['09L', '09R', '10L', '10R', '27L', '27R', '28L', '28R'] },
  KMSP: { name: 'Minneapolis-St Paul Intl', lat: 44.8820, lon: -93.2218, runways: ['04', '12L', '12R', '17', '22', '30L', '30R'] },
  KLGA: { name: 'LaGuardia', lat: 40.7769, lon: -73.8740, runways: ['04', '13', '22', '31'] },
  KDTW: { name: 'Detroit Metro Wayne County', lat: 42.2124, lon: -83.3534, runways: ['03', '04L', '04R', '09L', '09R', '21', '22L', '22R', '27L', '27R'] },
  KPHL: { name: 'Philadelphia Intl', lat: 39.8744, lon: -75.2428, runways: ['08', '09L', '09R', '17', '26', '27L', '27R', '35'] },
  KBWI: { name: 'Baltimore-Washington Intl', lat: 39.1754, lon: -76.6683, runways: ['10', '15L', '15R', '28', '33L', '33R'] },
  ...
  KMDW: { name: 'Chicago Midway Intl', lat: 41.7868, lon: -87.7522, runways: ['04L', '04R', '13C', '13L', '13R', '22L', '22R', '31C', '31L', '31R'] },
  ...
  PHNL: { name: 'Daniel K Inouye Intl', lat: 21.3245, lon: -157.9251, runways: ['04L', '04R', '08L', '08R', '26L', '26R'] },
  KBNA: { name: 'Nashville Intl', lat: 36.1263, lon: -86.6774, runways: ['02L', '02C', '02R', '13', '20L', '20C', '20R', '31'] },
  KAUS: { name: 'Austin-Bergstrom Intl', lat: 30.1975, lon: -97.6664, runways: ['17L', '17R', '18L', '18R', '35L', '35R', '36L', '36R'] },
  KSTL: { name: 'St Louis Lambert Intl', lat: 38.7487, lon: -90.3700, runways: ['06', '11', '12R', '24', '29', '30L'] },
  KSLC: { name: 'Salt Lake City Intl', lat: 40.7883, lon: -111.9778, runways: ['14', '16L', '16R', '17', '34L', '34R', '35'] },
  KMCI: { name: 'Kansas City Intl', lat: 39.2976, lon: -94.7139, runways: ['01L', '01R', '09', '19L', '19R', '27'] },
  KRDU: { name: 'Raleigh-Durham Intl', lat: 35.8801, lon: -78.7880, runways: ['05L', '05R', '14', '23L', '23R', '32'] },
  KSMF: { name: 'Sacramento Intl', lat: 38.6951, lon: -121.5901, runways: ['08L', '08R', '17L', '17R', '26L', '26R', '35'] },
  KMSY: { name: 'New Orleans Louis Armstrong Intl', lat: 29.9934, lon: -90.2580, runways: ['02', '11', '20', '29'] },
  KSJC: { name: 'San Jose Intl', lat: 37.3639, lon: -121.9289, runways: ['11', '12L', '12R', '30L', '30R'] },
  KOAK: { name: 'San Francisco Bay Oakland Intl', lat: 37.7214, lon: -122.2208, runways: ['10L', '10R', '11', '28L', '28R', '29'] },
  ...
  KCLE: { name: 'Cleveland Hopkins Intl', lat: 41.4117, lon: -81.8498, runways: ['06L', '06R', '10', '24L', '24R', '28'] },
  ...
  KCMH: { name: 'John Glenn Columbus Intl', lat: 39.9980, lon: -82.8919, runways: ['10L', '10R', '28L', '28R'] },
  KCVG: { name: 'Cincinnati/Northern Kentucky Intl', lat: 39.0533, lon: -84.6630, runways: ['09', '18C', '18L', '18R', '27', '36C', '36L', '36R'] },
  KMKE: { name: 'Milwaukee Mitchell Intl', lat: 42.9476, lon: -87.8969, runways: ['01L', '01R', '07L', '07R', '13', '19L', '19R', '25L', '25R', '31'] },
  ...
  KIAD: { name: 'Washington Dulles Intl', lat: 38.9531, lon: -77.4565, runways: ['01L', '01R', '01C', '12', '19L', '19R', '19C', '30'] },
  ...
  KGEG: { name: 'Spokane Intl', lat: 47.6190, lon: -117.5338, runways: ['03', '07', '21', '25'] },
  KELP: { name: 'El Paso Intl', lat: 31.8072, lon: -106.3776, runways: ['04', '08', '22', '26'] },
  KMEM: { name: 'Memphis Intl', lat: 35.2140, lon: -89.9770, runways: ['09', '18C', '18L', '18R', '27', '36C', '36L', '36R'] },
  ...
  PANC: { name: 'Ted Stevens Anchorage Intl', lat: 61.1743, lon: -149.9983, runways: ['07L', '07R', '15', '25L', '25R', '33'] },
  KLIT: { name: 'Bill and Hillary Clinton National', lat: 34.7294, lon: -92.2242, runways: ['04L', '04R', '22L', '22R'] },
  ...
  KDSM: { name: 'Des Moines Intl', lat: 41.5340, lon: -93.6631, runways: ['05', '13', '23', '31'] },
  KICT: { name: 'Wichita Dwight D Eisenhower National', lat: 37.6499, lon: -97.4331, runways: ['01L', '01R', '14', '19L', '19R', '32'] },
  ...
  KBZN: { name: 'Bozeman Yellowstone Intl', lat: 45.7776, lon: -111.1600, runways: ['03', '11', '28', '36'] },
  ...
  KABQ: { name: 'Albuquerque Intl Sunport', lat: 35.0402, lon: -106.6090, runways: ['03', '08', '12', '17', '21', '26', '30', '35'] },
  KFAR: { name: 'Hector Intl', lat: 46.9207, lon: -96.8184, runways: ['09', '13', '18', '27', '31', '36'] },
  KOKC: { name: 'Will Rogers World', lat: 35.3931, lon: -97.6007, runways: ['13L', '13R', '17L', '17R', '31L', '31R', '35L', '35R'] },
  ...
  KFSD: { name: 'Sioux Falls Regional', lat: 43.5820, lon: -96.7419, runways: ['03', '15', '21', '33'] },
  ...
  EHAM: { name: 'Amsterdam Schiphol', lat: 52.3105, lon: 4.7683, runways: ['04', '06', '09', '18C', '18L', '18R', '22', '24', '27', '36C', '36L', '36R'] },
  LEMD: { name: 'Madrid Barajas', lat: 40.4983, lon: -3.5676, runways: ['14L', '14R', '18L', '18R', '32L', '32R', '36L', '36R'] },
  ...
  LTFM: { name: 'Istanbul', lat: 41.2753, lon: 28.7519, runways: ['16L', '16R', '17L', '17R', '18', '34L', '34R', '35L', '35R', '36'] },
  ...
  EBBR: { name: 'Brussels', lat: 50.9010, lon: 4.4844, runways: ['01', '07L', '07R', '19', '25L', '25R'] },
  ...
  VHHH: { name: 'Hong Kong Intl', lat: 22.3080, lon: 113.9185, runways: ['07L', '07R', '25L', '25R'] },
  RJAA: { name: 'Tokyo Narita Intl', lat: 35.7647, lon: 140.3864, runways: ['16L', '16R', '34L', '34R'] },
  RJTT: { name: 'Tokyo Haneda', lat: 35.5494, lon: 139.7798, runways: ['04', '05', '16L', '16R', '22', '23', '34L', '34R'] },
  ...
  ZSPD: { name: 'Shanghai Pudong Intl', lat: 31.1443, lon: 121.8083, runways: ['16L', '16R', '17L', '17R', '34L', '34R', '35L', '35R'] },
  ...
  YSSY: { name: 'Sydney Kingsford Smith', lat: -33.9399, lon: 151.1753, runways: ['07', '16L', '16R', '25', '34L', '34R'] },
  ...
  SCEL: { name: 'Santiago Arturo Merino Benitez', lat: -33.3930, lon: -70.7858, runways: ['17L', '17R', '35L', '35R'] },
  FAOR: { name: 'Johannesburg OR Tambo', lat: -26.1392, lon: 28.2460, runways: ['03L', '03R', '21L', '21R'] },
  ...
  ENFL: { name: 'Floro', lat: 61.5833, lon: 5.0250, runways: ['07', '25'] },
  ...
  EKCH: { name: 'Copenhagen Kastrup', lat: 55.6180, lon: 12.6561, runways: ['04L', '04R', '12', '22L', '22R', '30'] },
...
export const WAYPOINTS: Record<string, { lat: number; lon: number }> = {
  ...
  MERIT: { lat: 40.933, lon: -73.600 },
  CIVET: { lat: 41.217, lon: -71.500 },
  DEEZZ: { lat: 40.600, lon: -74.000 },
  SHIPP: { lat: 41.000, lon: -71.800 },
  NELIE: { lat: 40.400, lon: -74.500 },
  VIKNG: { lat: 40.200, lon: -74.800 },
  BRAND: { lat: 41.500, lon: -73.833 },
  GREKI: { lat: 42.833, lon: -78.667 },
  LAKES: { lat: 42.000, lon: -80.000 },
  BUGSY: { lat: 41.667, lon: -72.833 },
  HARTF: { lat: 41.767, lon: -72.683 },
  ALB: { lat: 42.750, lon: -73.800 },
  SYR: { lat: 43.117, lon: -76.117 },
  ROC: { lat: 43.117, lon: -77.667 },
  BUF: { lat: 42.940, lon: -78.733 },
  BOS: { lat: 42.367, lon: -71.017 },
  MHT: { lat: 42.933, lon: -71.433 },
  PWM: { lat: 43.650, lon: -70.300 },
  BGR: { lat: 44.800, lon: -68.833 },
  BTV: { lat: 44.467, lon: -73.150 },
  PHL: { lat: 39.867, lon: -75.233 },
  PIT: { lat: 40.500, lon: -80.233 },
  CLE: { lat: 41.417, lon: -81.850 },
  CMH: { lat: 40.000, lon: -82.883 },
  CVG: { lat: 39.050, lon: -84.667 },
  IND: { lat: 39.717, lon: -86.300 },
  DTW: { lat: 42.217, lon: -83.350 },
  MKE: { lat: 42.950, lon: -87.900 },
  MSP: { lat: 44.883, lon: -93.217 },
  FAR: { lat: 46.917, lon: -96.817 },
  DSM: { lat: 41.533, lon: -93.650 },
  OMA: { lat: 41.300, lon: -95.900 },
  MCI: { lat: 39.300, lon: -94.717 },
  STL: { lat: 38.750, lon: -90.367 },
  LIT: { lat: 34.733, lon: -92.233 },
  TUL: { lat: 36.200, lon: -95.883 },
  OKC: { lat: 35.400, lon: -97.600 },
